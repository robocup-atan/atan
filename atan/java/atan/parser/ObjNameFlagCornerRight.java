...
class ObjNameFlagCornerRight implements ObjName {
    ...
    public void infoSeeFromEast(Controller c, double dist, double dir) {
      switch (qualifier) {
        case 't': c.infoSeeFlagCornerOwn(Controller.FLAG_RIGHT, dist, dir); break;
        case 'b': c.infoSeeFlagCornerOwn(Controller.FLAG_LEFT, dist, dir); break;
    ...
    public void infoSeeFromWest(Controller c, double dist, double dir) {
      switch (qualifier) {
        case 't': c.infoSeeFlagCornerOther(Controller.FLAG_LEFT, dist, dir); break;
        case 'b': c.infoSeeFlagCornerOther(Controller.FLAG_RIGHT, dist, dir); break;
