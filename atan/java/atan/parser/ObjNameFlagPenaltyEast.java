...
class ObjNameFlagPenaltyEast implements ObjName {
    ...
    public void infoSeeFromEast(Controller c, double dist, double dir) {
      switch(qualifier) {
        case 't': c.infoSeeFlagPenaltyOwn(Controller.FLAG_RIGHT, dist, dir);break;
        case 'b': c.infoSeeFlagPenaltyOwn(Controller.FLAG_LEFT, dist, dir);break;
    ...
    public void infoSeeFromWest(Controller c, double dist, double dir) {
      switch(qualifier) {
        case 't': c.infoSeeFlagPenaltyOther(Controller.FLAG_LEFT, dist, dir);break;
        case 'b': c.infoSeeFlagPenaltyOther(Controller.FLAG_RIGHT, dist, dir);break;
