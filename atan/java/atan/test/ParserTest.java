...
public class ParserTest extends TestCase {
  ...
  public void testCmdParserInit00() throws ParseException{
    ...
    co.getResult().contains("|infoHearPlayMode|"+Controller.PLAY_MODE_BEFORE_KICK_OFF);
  }
  ...
  public void testCmdParserGoal00() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagGoalOther|1000|-1.4|11.0");
  }
  public void testCmdParserGoal01() {
    String cmd = "(see 1 ((goal l)11))";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagGoalOther|1000|100.0|11.0");
  }
  public void testCmdParserGoal02() {
    String cmd = "(see 1 ((goal r)110))";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagGoalOwn|1000|100.0|110.0");
  }
  ...
  public void testCmdParserFlag00() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagCenter|1000|22.0|110.0");
  }
  public void testCmdParserFlag01() {
    String cmd = "(see 1 ((flag c t)22 110))";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagCenter|1004|22.0|110.0");
  }
  public void testCmdParserFlag02() {
    String cmd = "(see 1 ((flag c b)22.1 110))";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSeeFlagCenter|1003|22.1|110.0");
  }
  ...
  public void testCmdParserMulti00() {
    ...
    assertResult(cmd, result, "|infoSeeLine|2003|23.0|110.0");
    assertResult(cmd, result, "|infoSeeLine|2003|23.0|111.0");
  }
  public void testCmdParserMulti01() {
    ...
    assertResult(cmd, result, "|infoSeePlayerOwn|1|13.4|-2.0");
    assertResult(cmd, result, "|infoSeeFlagGoalOwn|1000|100.0|110.0");
    assertResult(cmd, result, "|infoSeeFlagCenter|1003|22.0|110.0");
  }
  public void testCmdParserSenseBody00() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSenseBody|0|4|12.0|-23.3|12.0|121|100|111|99|145");
  }
  public void testCmdParserSenseBody01() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoSenseBody|1|2|12.0|23.0|12.0|121|100|111|99|145");
  }
  ...
  public void testCmdParserInit02() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_BEFORE_KICK_OFF);
  }
  public void testCmdParserInit03() {
    String cmd = "(init r 1 corner_kick_l)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_CORNER_KICK_OTHER);
  }
  ...
  public void testCmdParserInit04() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_CORNER_KICK_OWN);
  }
  ...
  public void testCmdParserInit06() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_FREE_KICK_OTHER);
  }
  ...
  public void testCmdParserInit08() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_FREE_KICK_OWN);
  }
  ...
  public void testCmdParserInit10() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_GOAL_KICK_OTHER);
  }
  ...
  public void testCmdParserInit12() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_GOAL_KICK_OWN);
  }
  ...
  public void testCmdParserInit14() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_GOAL_OTHER);
  }
  ...
  public void testCmdParserInit16() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_GOAL_OWN);
  }
  ...
  public void testCmdParserInit18() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_KICK_IN_OTHER);
  }
  ...
  public void testCmdParserInit20() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_KICK_IN_OWN);
  }
  ...
  public void testCmdParserInit23() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_KICK_OFF_OTHER);
  }
  ...
  public void testCmdParserInit25() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_KICK_OFF_OWN);
  }
  ...
  public void testCmdParserInit27() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearPlayMode|"+Controller.PLAY_MODE_TIME_OVER);
  }
  ...
  public void testCmdParserHearRefereeA00a() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_OFFSIDE_OTHER);
  }
  public void testCmdParserHearRefereeA00b() {
    String cmd = "(hear 55 referee offside_r)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_OFFSIDE_OWN);
  }
  public void testCmdParserHearRefereeA00() {
    String cmd = "(hear 55 referee foul_l)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_FOUL_OTHER);
  }
  public void testCmdParserHearRefereeA01() {
    String cmd = "(hear 55 referee foul_r)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_FOUL_OWN);
  }
  ...
  public void testCmdParserHearRefereeA03() {
    ...
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_HALF_TIME);
  }
  public void testCmdParserHearRefereeA04() {
    String cmd = "(hear 55 referee time_extended)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_TIME_EXTENDED);
  }
  public void testCmdParserHearRefereeA05() {
    String cmd = "(hear 55 referee time_up)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_TIME_UP);
  }
  public void testCmdParserHearRefereeA06() {
    String cmd = "(hear 55 referee time_up_without_a_team)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_TIME_UP_WITHOUT_A_TEAM);
  }
  public void testCmdParserHearRefereeA07() {
    String cmd = "(hear 55 referee drop_ball)";
    Set result = parseCmd(cmd);
    assertEquals(1, result.size());
    assertResult(cmd, result, "|infoHearReferee|"+Controller.REFREE_MESSAGE_DROP_BALL);
  }
