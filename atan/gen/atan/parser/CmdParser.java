...
public class CmdParser implements CmdParserConstants {
     ...
     * @param encoding
     */
    public CmdParser(java.io.InputStream stream, String encoding) {
        try {
     ...
     */
    public void parseSeeCommand(String cmd, Controller controller, Player player) throws ParseException {
     ...
     * @throws ParseException
     */
    public void parseHearCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
        startHearCommand();
     ...
     * @throws ParseException
     */
    public void parseInitCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
        startInitCommand();
     ...
     * @throws ParseException
     */
    public void parseErrorCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
        startErrorCommand();
     ...
     * @throws ParseException
     */
    public void parseSenseBodyCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
     ...
     * @throws ParseException
     */
    public void parseOkCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
        startOkCommand();
     ...
     * @throws ParseException
     */
    public void parseWarningCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
        startWarningCommand();
     ...
     * @throws ParseException
     */
    public void parseServerParamCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
     ...
     * @throws ParseException
     */
    public void parsePlayerParamCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
     ...
     * @throws ParseException
     */
    public void parsePlayerTypeCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
     ...
     * @throws ParseException
     */
    public void parseChangePlayerTypeCommand(String cmd, Controller controller, Player player) throws ParseException {
        ReInit(new StringReader(cmd));
        this.controller = controller;
        this.player     = player;
    ...
    final public void startSenseBodyCommand() throws ParseException {
        ...
        controller.infoSenseBody(iViewModeQual, iViewModeAngle, dStamina.doubleValue(), dSpeedAmount.doubleValue(),
                                 dHeadAngle.doubleValue(), iKick.intValue(), iDash.intValue(), iTurn.intValue(),
                                 iSay.intValue(), iTurnNeck.intValue());
    }

//  Commands I don't yet care about! Need to be implemented later...
