/* Generated By:JavaCC: Do not edit this line. CmdParser.java */
  ...
  public class CmdParser implements CmdParserConstants {
    ...
    public void parseSeeCommand (String cmd, Controller controller, Player player)
    ...
    public void parseHearCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseInitCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseErrorCommand (String cmd, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
    ...
    public void parseSenseBodyCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
  ...
  final public int playMode() throws ParseException {
    if (jj_2_81(2)) {
      ...
      {if (true) return Controller.PLAY_MODE_BEFORE_KICK_OFF;}
    } else if (jj_2_82(2)) {
      jj_consume_token(TIME_OVER);
      {if (true) return Controller.PLAY_MODE_TIME_OVER;}
    } else if (jj_2_83(2)) {
      jj_consume_token(PLAY_ON);
      {if (true) return Controller.PLAY_MODE_PLAY_ON;}
    } else if (jj_2_84(2)) {
      jj_consume_token(KICK_OFF_L);
      if (player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_KICK_OFF_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_KICK_OFF_OWN;}
    } else if (jj_2_85(2)) {
      ...
      if (player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_KICK_IN_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_KICK_IN_OWN;}
    } else if (jj_2_87(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_FREE_KICK_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_FREE_KICK_OWN;}
    } else if (jj_2_89(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_CORNER_KICK_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_CORNER_KICK_OWN;}
    } else if (jj_2_91(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_GOAL_KICK_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_GOAL_KICK_OWN;}
    } else if (jj_2_93(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.PLAY_MODE_GOAL_OTHER;}
      else
        {if (true) return Controller.PLAY_MODE_GOAL_OWN;}
    } else if (jj_2_95(2)) {
  ...
  final public int refereeMessage() throws ParseException {
    if (jj_2_96(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.REFREE_MESSAGE_OFFSIDE_OTHER;}
      else
        {if (true) return Controller.REFREE_MESSAGE_OFFSIDE_OWN;}
    } else if (jj_2_97(2)) {
      ...
      if (!player.isTeamEast())
        {if (true) return Controller.REFREE_MESSAGE_FOUL_OTHER;}
      else
        {if (true) return Controller.REFREE_MESSAGE_FOUL_OWN;}
    } else if (jj_2_99(2)) {
      ...
      jj_consume_token(HALF_TIME);
        {if (true) return Controller.REFREE_MESSAGE_HALF_TIME;}
    } else if (jj_2_101(2)) {
      jj_consume_token(DROP_BALL);
        {if (true) return Controller.REFREE_MESSAGE_DROP_BALL;}
    } else if (jj_2_102(2)) {
      jj_consume_token(TIME_UP);
        {if (true) return Controller.REFREE_MESSAGE_TIME_UP;}
    } else if (jj_2_103(2)) {
      jj_consume_token(TIME_UP_WITHOUT_A_TEAM);
        {if (true) return Controller.REFREE_MESSAGE_TIME_UP_WITHOUT_A_TEAM;}
    } else if (jj_2_104(2)) {
      jj_consume_token(TIME_EXTENDED);
        {if (true) return Controller.REFREE_MESSAGE_TIME_EXTENDED;}
    } else {
      jj_consume_token(-1);
      throw new ParseException();
    }
