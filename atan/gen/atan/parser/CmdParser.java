...
import atan.model.enums.Warning;
  ...
  public class CmdParser implements CmdParserConstants {
    ...
    public void parseErrorCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseOkCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseWarningCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseServerParamCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parsePlayerParamCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parsePlayerTypeCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
    ...
    public void parseChangePlayerTypeCommand (String cmd, Controller controller, Player player)
        throws ParseException{
      ReInit(new StringReader(cmd));
      this.controller = controller;
      this.player = player;
  ...
  Token unknown=null;
    ...
    jj_consume_token(CB);
      ...
      controller.infoSenseBody(
        ...
        dStamina.doubleValue(), dSpeedAmount.doubleValue(),
...
//Get object details.
  final public void objInfo() throws ParseException {
   ObjName name; Token p1=null; Token p2=null; Token p3=null; Token p4=null; Token p5=null; Token p6=null;
    jj_consume_token(OB);
    name = objName();
    jj_consume_token(CB);
    jj_consume_token(SEP);
