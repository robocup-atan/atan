...
/**
 * <p>ObjNameFlagPenaltyEastTest class.</p>
 *
 * @author Atan
 * @since 1.0
 */
public class ObjNameFlagPenaltyEastTest {

    /**
     * <p>Constructor for ObjNameFlagPenaltyEastTest.</p>
     */
    public ObjNameFlagPenaltyEastTest() {}
    ...
    /**
     * Test of infoSeeFromEast method, of class ObjNameFlagPenaltyEast.
     */
    @Test
    public void testInfoSeeFromEast_7args_1() {
        ...
        ObjNameFlagPenaltyEast instance            = new ObjNameFlagPenaltyEast('b');
        instance.infoSeeFromEast(c, distance, direction, distChange, dirChange, bodyFacingDirection,
                                 headFacingDirection);
    }

    /**
     * Test of infoSeeFromWest method, of class ObjNameFlagPenaltyEast.
     */
    @Test
    ...
    /**
     * Test of infoSee method, of class ObjNameFlagPenaltyEast.
     */
    @Test(expected = UnsupportedOperationException.class)
