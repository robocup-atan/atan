...
import com.github.robocup_atan.atan.parser.objects.ObjNameFlagGoalEast;
...
/**
 * <p>ObjNameFlagGoalEastTest class.</p>
 *
 * @author Atan
 * @since 1.0
 */
public class ObjNameFlagGoalEastTest {

    /**
     * <p>Constructor for ObjNameFlagGoalEastTest.</p>
     */
    public ObjNameFlagGoalEastTest() {}
    ...
    /**
     * Test of infoSeeFromEast method, of class ObjNameFlagGoalEast.
     */
    @Test
    public void testInfoSeeFromEast_7args_1() {
        ...
        ObjNameFlagGoalEast instance            = new ObjNameFlagGoalEast('t');
        instance.infoSeeFromEast(c, distance, direction, distChange, dirChange, bodyFacingDirection,
                                 headFacingDirection);
    }

    /**
     * Test of infoSeeFromWest method, of class ObjNameFlagGoalEast.
     */
    @Test
    ...
    /**
     * Test of infoSee method, of class ObjNameFlagGoalEast.
     */
    @Test(expected = UnsupportedOperationException.class)
