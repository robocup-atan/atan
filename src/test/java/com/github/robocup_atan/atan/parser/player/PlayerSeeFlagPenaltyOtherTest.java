...
public class PlayerSeeFlagPenaltyOtherTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                {"(see 123.45 ((f p l b) 123.45 123.45 123.45 123.45 123.45 123.45))", true,  Flag.LEFT,   123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f p l) 123.45 123.45 123.45 123.45 123.45 123.45))",   true,  Flag.CENTER, 123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f p l t) 123.45 123.45 123.45 123.45 123.45 123.45))", true,  Flag.RIGHT,  123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                // West team see other goal flag messages.
                {"(see 123.45 ((f p r b) 123.45 123.45 123.45 123.45 123.45 123.45))", false, Flag.RIGHT,  123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f p r) 123.45 123.45 123.45 123.45 123.45 123.45))",   false, Flag.CENTER, 123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f p r t) 123.45 123.45 123.45 123.45 123.45 123.45))", false, Flag.LEFT,   123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
    ...
    public PlayerSeeFlagPenaltyOtherTest(
        String  command,
        boolean isTeamEast,
        Flag    flag,
        double  distance,
    ...
    private class TestController extends BaseControllerPlayer {
        ...
        @Override
        public void infoSeeFlagPenaltyOther(
            Flag flag,
            double distance,
            double direction,
            double distChange,
