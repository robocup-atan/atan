...
public class PlayerSeeFlagCornerOtherTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] {
                ...
                /**
                 * Tests for seeing the corner flags are captured in the
                ...
                {"(see 123.45 ((f l b) 123.45 123.45 123.45 123.45 123.45 123.45))", true,  Flag.LEFT,   123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f l t) 123.45 123.45 123.45 123.45 123.45 123.45))", true,  Flag.RIGHT,  123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                // West team see other goal flag messages.
                {"(see 123.45 ((f r b) 123.45 123.45 123.45 123.45 123.45 123.45))", false, Flag.RIGHT,  123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
                {"(see 123.45 ((f r t) 123.45 123.45 123.45 123.45 123.45 123.45))", false, Flag.LEFT,   123.45, 123.45, 123.45, 123.45, 123.45, 123.45},
    ...
    public PlayerSeeFlagCornerOtherTest(
        String  command,
        boolean isTeamEast,
        Flag    flag,
        double  distance,
    ...
    private class TestController extends BaseControllerPlayer {
        ...
        @Override
        public void infoSeeFlagCornerOther(
            Flag flag,
            double distance,
            double direction,
            double distChange,
