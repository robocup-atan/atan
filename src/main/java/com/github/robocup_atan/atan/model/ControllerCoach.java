...
public interface ControllerCoach {
	 ...
	 * @param deltaX
	 *            The players change of speed on the x plane.
	 * @param deltaY
	 *            The players change of speed on the y plane.
	 * @param bodyAngle
	 *            The players body angle.
	 * @param neckAngle
	 *            The players neck angle.
	 */
	public void infoSeePlayerOwn(int number, boolean goalie, double x,
			double y, double deltaX, double deltaY, double bodyAngle,
			double neckAngle);
	 ...
	 *            The players neck angle.
	 */
	public void infoSeePlayerOther(int number, boolean goalie, double x,
			double y, double deltaX, double deltaY, double bodyAngle,
			double neckAngle);
	 ...
	 *
	 * @param x
	 *            The x coordinate of the center of the goal.
	 * @param y
	 *            The y coordinate of the center of the goal.
	 */
	 ...
	 * @param deltaX
	 *            The balls change in speed on the x plane.
	 * @param deltaY
	 *            The balls change in speed on the y plane.
	 */
	public void infoSeeBall(double x, double y, double deltaX, double deltaY);

	/**
	 * The controller is informed of the connected teams names. Empty string if
	 * no team connected.
	 *
	 * @param teamWest
	 *            The name of the west team.
	 * @param teamEast
	 *            The name of the east team.
	 */
	 ...
	 * @param team
	 *            The name of the team of the player saying something.
	 * @param message
	 *            The actual message said.
	 */
	public void infoHearPlayer(double direction, String team, String message);
	 ...
	 * 
	 * @param cycle
	 *            is the current cycle providied by the Server
	 */
