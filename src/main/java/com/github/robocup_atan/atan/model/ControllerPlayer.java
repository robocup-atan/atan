...
public interface ControllerPlayer {
	...
	/**
	 * This is the method called before the controller receives all the new
	 * visual information.
	 */
	public void preInfo();

	/**
	 * This is the method called one all the visual information has been
	 * processed.
	 */
	 ...
	 *
	 * @param newType
	 *            what the type will now be
	 */
	public void setType(String newType);

	/**
	 * The controller is informed when one object is in sight but it is unknown which specific object.
	 * As stated in the manual the object could be a goal, flag or player. This is indicated by the Unknown
	 * Object.
	 *
	 * @param type
	 * 			  Could be GOAL, FLAG or PLAYER. If it can't be assigned type is NULL.
	 * @param distance
	...
	/**
	 * The controller is informed when one of the flags along the right
	 * touchline is in sight. The flags are positioned 5m behind the touchline.
	 *
	 * @param flag
	 *            possible values: OWN_50, OWN_40, OWN_30, OWN_20, OWN_10,
	 *            CENTER, OTHER_10, OTHER_20, OTHER_30, OTHER_40, OTHER_50
	 * @param distance
	...
	/**
	 * The controller is informed when one of the flags behind our teams goal is
	 * in sight. These flags are positioned 5m behind the goal line.
	 *
	 * @param flag
	 *            possible values: LEFT_10, LEFT_20, LEFT_30, CENTER, RIGHT_10,
	 *            RIGHT_20, RIGHT_30
	 * @param distance
	 *            The distance to the flag.
	 * @param direction
	...
	/**
	 * The controller is informed that one of our teams corner flags is in
	 * sight.
	 *
	 * @param flag
	...
	/**
	 * The controller is informed that one of the other teams corner flags is in
	 * sight.
	 *
	 * @param flag
	 *            possible values: LEFT, RIGHT
	...
	/**
	 * The controller is informed that one of our teams penalty box flags is in
	 * sight. The flags map the outer most corners of the penalty box and the
	 * centre point between these corners.
	 *
	 * @param flag
	 *            possible values: LEFT, CENTER, RIGHT
	 * @param distance
	 *            The distance to this flag.
	 * @param direction
	 *            The direction of this flag.
	 * @param distChange
	 *            a double.
	 * @param dirChange
	 *            a double.
	...
	/**
	 * The controller is informed that one of the other teams penalty box flags
	 * is in sight. The flags map the outer most corners of the penalty box and
	 * the centre point between these corners.
	 *
	 * @param flag
	 *            possible values: LEFT, CENTER, RIGHT
	 * @param distance
	 ...
	 * The flags map the posts of the goal and the center of the goal.
	 *
	 * @param flag
	 *            possible values: LEFT, CENTER, RIGHT
	 * @param distance
	...
	/**
	 * The controller is informed that one of the other teams goal flags is in
	 * sight. The flags map the posts of the goal and the center of the goal.
	 *
	 * @param flag
	 *            possible values: LEFT, CENTER, RIGHT
	 * @param distance
	 ...
	 *
	 * @param line
	 *            a {@link com.github.robocup_atan.atan.model.enums.Line}
	 *            object.
	 * @param distance
	...
	/**
	 * The controller is informed that one of the other teams players is in
	 * sight.
	 *
	 * @param number
	 *            The ID of the player (from 1 to 11)
	 * @param goalie
	 *            If the seen player is a goalie. False if unknown.
	 * @param distance
	 ...
	 *            possible values: FOUL_OWN, FOUL_OTHER, HALF_TIME, TIME_UP,
	 *            TIME_UP_WITHOUT_A_TEAM, TIME_EXTENDED, DROP_BALL, OFFSIDE_OWN,
	 *            OFFSIDE_OTHER
	 */
	 ...
	 *            KICK_OFF_OWN, KICK_OFF_OTHER, FREE_KICK_OWN, FREE_KICK_OTHER,
	 *            GOAL_KICK_OWN, CORNER_KICK_OTHER, GOAL_KICK_OWN,
	 *            GOAL_KICK_OTHER, GOAL_OWN, GOAL_OTHER
	 */
	 ...
	 *
	 * @param direction
	 *            The direction from which the message originated.
	 * @param message
	 ...
	 * @param viewAngle
	 *            possible values: NARROW, NORMAL, WIDE
	 * @param stamina
	 *            a double.
	 * @param unknown
	 *            a double.
	...
	public void infoSenseBody(ViewQuality viewQuality, ViewAngle viewAngle,
			double stamina, double effort, double capacity, double speedAmount,
	...
	/**
	 * The controller is informed when the change player type message is
	 * received.
	 *
	 * @param unum
	 *            The players uniform number.
	 * @param type
	 *            The players type.
	 */
	 ...
	 *
	 * @param info
	 *            A hashmap containing all the server param details.
	 */
	public void infoServerParam(HashMap<ServerParams, Object> info);
	/**
	 * Sets the current cycle provided by the RoboCup Server
	 * @param cycle is the current cycle providied by the Server
	 */
